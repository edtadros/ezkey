...
- New items ezkey creates may also be readable by `/usr/bin/security` so the documented CLI round-trip works. Updates do not rewrite existing access-control lists.
