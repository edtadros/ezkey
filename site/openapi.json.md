...
Errors use RFC 9457 `application/problem+json`. Rate limit: 10 requests per 10 seconds per IP. No authentication. See [auth.md](https://ezkey.app/auth.md) and [developers](https://ezkey.app/developers.md).
